...
public class StringUtils {
	...
	/**
	 * For two <code>Strings</code> <code>A</code> and <code>B</code> the <code>Match</code> is:<br>
	 * <code>match = match - ( editDistance / ( 2 * titleLength ) ) * 100</code><br>
	 * with <code>match = 100.0</code>  and for edit distance see <code>editDistance (String, String)</code>.
